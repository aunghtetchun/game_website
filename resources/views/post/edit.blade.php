                                    ...
                                    <div class="form-group d-flex flex-wrap mb-0">
                                        <div class="form-group col-md-6 pl-lg-0 pl-md-0">
                                            <div class="form-group justify-content-center align-items-center">
                                                ...
                                                <input type="file" accept="image/png, .jpeg, .jpg, image/gif" class="form-control d-none  p-1 @error('logo') is-invalid @enderror" name="logo" id="logo" value="{{old('logo')}}" placeholder="Ads Logo" onchange="readURL(this);">
                                                @error('logo')
                                                <small class="invalid-feedback font-weight-bold" role="alert">
                                                    {{ $message }}
                                                </small>
                                                ...
                                                <img id="blah" onclick="$('#logo').trigger('click');" class="w-100 rounded" src="{{ asset("/storage/thumbnail/".$post->logo)}}" alt="your image" />
                                            </div>
                                        </div>
                        ...
                        @foreach($post->getPhoto as $photo)
                            <div class="mr-2" >
                                ...
                                <form action="{{ route('photo.destroy',$photo->id) }}"  method="post">
                                    @csrf
                                    @method("DELETE")
                                    <button href="" class="btn  btn-sm btn-danger text-left" style="margin-top: -330px; margin-left: 8px">
