...
<head>
    <meta charset="UTF-8">
    <!-- Primary Meta Tags -->
    {{--    <title>Welcome From AHC Games Myanmar</title>--}}
    <meta name="title" content="Welcome From AHC Games Myanmar">
    <meta name="description" content="Welcome from ahc games myanmar. You can download all mod games here.">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="Welcome from ahc games myanmar. You can download all mod games here.">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="@yield('meta_title','Welcome from ahc games myanmar. You can download all mod games here.')">
    <meta property="og:description" content="@yield('meta_description','Welcome from ahc games myanmar. You can download all mod games here.')">
    <meta property="og:image" content="@yield('meta_image', asset(\App\Custom::$info['c-logo']) )">
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="Welcome from ahc games myanmar. You can download all mod games here.">
    <meta property="twitter:description" content="Welcome from ahc games myanmar. You can download all mod games here.">
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1638939171597659"
                ...
                <div class="row">
                    <div class="col-12 p-0 py-2 ">
                        <nav class="navbar navbar-expand-md navbar-dark ">
                            ...
                            <span class="h3 pl-2 text-white gsmm" onclick="location.href='{{route('game.gameList')}}'"  style="cursor: pointer">AHC</span>
